...
const OAUTH2_ACCESS_TOKEN_URL = process.env.OAUTH2_ACCESS_TOKEN_URL
const OAUTH2_AUTHORIZATION_URL = process.env.OAUTH2_AUTHORIZATION_URL
const OAUTH2_REDIRECT_URL = process.env.OAUTH2_REDIRECT_URL
...
export default {
  ...
  getCodeFromUrl: (url: string): string => {
    ...
    return parse.query.code.toString()
  },
